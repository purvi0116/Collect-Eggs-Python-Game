...
class Basket_hidden(Sprite):
    ...
    def update(self,basket_upper):
        ...
        self.center=basket_upper.center
        self.rect.centerx=basket_upper.rect.centerx
